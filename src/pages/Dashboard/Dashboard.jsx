              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px', boxSizing: 'border-box' }}>
                ...
                <div style={{ boxSizing: 'border-box' }}>
                  ...
                  <div style={{ marginBottom: '15px' }}>
                    ...
                    <input type="text" name="name" value={companyForm.name} onChange={handleCompanyChange} style={{ ...inputStyle, fontWeight: 'bold' }} placeholder="e.g. Manish Pvt Ltd" autoFocus />
                  </div>
                  <div style={{ marginBottom: '15px' }}>
                    <label style={{ ...labelStyle, color: '#000000' }}>Registered Address</label>
                    <textarea name="address" value={companyForm.address} onChange={handleCompanyChange} style={{ ...inputStyle, resize: 'none', height: '60px' }}></textarea>
                  </div>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                    ...
                    <div>
                      ...
                      <input type="text" name="pin" value={companyForm.pin} onChange={handleCompanyChange} style={inputStyle} placeholder="800001" />
                    </div>
                  </div>
                </div>
                ...
                <div style={{ boxSizing: 'border-box' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '15px' }}>
                    <div>
                      ...
                      <input type="date" name="fyFrom" value={companyForm.fyFrom} onChange={handleCompanyChange} style={inputStyle} />
                    </div>
                    <div>
                      <label style={{ ...labelStyle, color: '#000000' }}>Books beginning from</label>
                      <input type="date" name="booksFrom" value={companyForm.booksFrom} onChange={handleCompanyChange} style={inputStyle} />
                    </div>
                  </div>

                  <div style={{ marginBottom: '15px' }}>
                    <label style={{ ...labelStyle, color: '#000000' }}>GSTIN / UIN</label>
                    <input type="text" name="gstinUin" value={companyForm.gstinUin} onChange={handleCompanyChange} style={{ ...inputStyle, textTransform: 'uppercase' }} placeholder="22AAAAA0000A1Z5" />
                  </div>

                  <div style={{ marginBottom: '15px' }}>
                    <label style={{ ...labelStyle, color: '#000000' }}>PAN / IT No.</label>
                    <input type="text" name="pan" value={companyForm.pan || ''} onChange={handleCompanyChange} style={{ ...inputStyle, textTransform: 'uppercase' }} placeholder="ABCDE1234F" />
                  </div>
                </div>
              </div>

              <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '20px', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '20px' }}>
                <button onClick={handleCompanySubmit} style={{
                  background: '#efe0ff',
                  color: '#8F00CC',
                  padding: '10px 30px',
